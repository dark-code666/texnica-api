...
public class StylesController : ControllerBase
{
    ...
    public StylesController(IStyleService service) => _service = service;
    ...
    [HttpPost]
    public async Task<IActionResult> Create(CreateStyleDto dto)
    {
    ...
    [HttpPut("{id}")]
    public async Task<IActionResult> Update(int id, UpdateStyleDto dto)
    {
