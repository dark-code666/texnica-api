...
[ApiController]
[Route("api/fabric-inventories")]
public class FabricInventoriesController : ControllerBase
{
    private readonly IFabricInventoryService _service;

    public FabricInventoriesController(IFabricInventoryService service) => _service = service;
    ...
    [HttpPost]
    public async Task<IActionResult> Create(CreateFabricInventoryDto dto)
    {
    ...
    [HttpPut("{id}")]
    public async Task<IActionResult> Update(int id, UpdateFabricInventoryDto dto)
    {
