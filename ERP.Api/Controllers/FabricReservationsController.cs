...
public class FabricReservationsController : ControllerBase
{
    private readonly IFabricReservationService _service;

    public FabricReservationsController(IFabricReservationService service) => _service = service;
    ...
    [HttpPost]
    public async Task<IActionResult> Create(CreateFabricReservationDto dto)
    {
    ...
    [HttpPut("{id}")]
    public async Task<IActionResult> Update(int id, UpdateFabricReservationDto dto)
    {
