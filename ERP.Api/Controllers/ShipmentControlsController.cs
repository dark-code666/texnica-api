...
[ApiController]
[Route("api/shipment-controls")]
public class ShipmentControlsController : ControllerBase
{
    private readonly IShipmentControlService _service;

    public ShipmentControlsController(IShipmentControlService service) => _service = service;
    ...
    [HttpPost]
    public async Task<IActionResult> Create(CreateShipmentControlDto dto)
    {
    ...
    [HttpPut("{id}")]
    public async Task<IActionResult> Update(int id, UpdateShipmentControlDto dto)
    {
